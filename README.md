...
웹 서핑 중 유용한 아티클을 발견해도
대부분은 *“일단 저장”*으로 끝나고 다시 열어보지 않게 됩니다.
...
다시 읽을 타이밍을 알려주지 않습니다.

MySave는 이러한 문제를 해결하기 위해
Chrome Extension을 통한 빠른 저장과
메모·태그·리마인드 기능을 결합하여
👉 저장한 정보를 실제로 다시 소비하도록 돕는 서비스를 목표로 합니다.

⭐ 주요 기능

🔖 북마크 CRUD: 링크, 메모 기반 북마크 생성·조회·수정·삭제

🏷️ 태그 관리: 태그 기반 분류 및 필터링

⏰ 리마인드 알림: 다시 읽을 시점을 설정하고 알림 제공

🌐 Chrome Extension 연동: 브라우징 중 즉시 북마크 저장

📊 웹 대시보드: 읽음/안읽음 상태 관리 및 검색 기능
